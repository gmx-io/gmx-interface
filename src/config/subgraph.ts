...
const SUBGRAPH_URLS = {
  [ARBITRUM]: {
    ...
    subsquid: "https://gmx-test.squids.live/gmx-synthetics-arbitrum@4db557/api/graphql",
  },
  ...
  [AVALANCHE]: {
    ...
    subsquid: "https://gmx-test.squids.live/gmx-synthetics-avalanche@4db557/api/graphql",
  },

...
const SUBGRAPH_URLS = {
  [ARBITRUM]: {
    ...
    subsquid: "https://gmx-test.squids.live/gmx-synthetics-arbitrum@v23/api/graphql",
  },
  ...
  [AVALANCHE]: {
    ...
    subsquid: "https://gmx-test.squids.live/gmx-synthetics-avalanche@v23/api/graphql",
  },

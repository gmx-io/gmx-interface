...
const SUBGRAPH_URLS = {
  ...
  [AVALANCHE_FUJI]: {
    ...
    subsquid: "https://gmx-test.squids.live/qwinn-avalanche-fuji@static/api/graphql",
  },

  [ARBITRUM_SEPOLIA]: {
    subsquid: "https://gmx-test.squids.live/multichain-arbitrum-sepolia@57a6e5/api/graphql",

...
const SUBGRAPH_URLS = {
  [ARBITRUM]: {
    ...
    subsquid: "https://gmx-test.squids.live/gmx-synthetics-arbitrum@v22/api/graphql",
  },
  ...
  [AVALANCHE]: {
    ...
    subsquid: "https://gmx-test.squids.live/gmx-synthetics-avalanche@v21/api/graphql",
  },

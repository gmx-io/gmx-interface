...
const SUBGRAPH_URLS = {
  [ARBITRUM]: {
    ...
    leaderboard: "https://squid.subsquid.io/gmx-synthetics-arbitrum/v/v3/graphql",
  },
  ...
  [AVALANCHE]: {
    ...
    leaderboard: "https://squid.subsquid.io/gmx-synthetics-avalanche/v/v2/graphql",
  },
  ...
  [AVALANCHE_FUJI]: {
    ...
    leaderboard: "https://squid.subsquid.io/gmx-synthetics-fuji/v/v3/graphql",
  },

...
const SUBGRAPH_URLS = {
  [ARBITRUM]: {
    ...
    leaderboard: "https://squid.subsquid.io/gmx-synthetics-arbitrum/v/v1/graphql",
  },
  ...
  [AVALANCHE]: {
    ...
    leaderboard: "https://squid.subsquid.io/gmx-synthetics-avalanche/v/v1/graphql",
  },
  ...
  [AVALANCHE_FUJI]: {
    ...
    leaderboard: "https://squid.subsquid.io/gmx-synthetics-fuji/v/v1/graphql",
  },

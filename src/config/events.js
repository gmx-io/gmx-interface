...
export const homeEventsData = [
  ...
  {
    id: "arbitrum-nitro-plan-reminder-2",
    title: "Arbitrum Nitro Upgrade",
    isActive: true,
    validTill: "31 Aug 2022, 12:00",
    bodyText:
      "Reminder: There will be some expected downtime during the Arbitrum Nitro upgrade happening in a few hours time on Wednesday, 31 Aug 2022, 2:30 PM UTC.",
    buttons: [
      {
        text: "Read More",

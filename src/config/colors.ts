...
export const colors = {
  ...
  affix: {
    "green-500": { light: "#68AE99", dark: "#1F9767" },
    "green-300": { light: "#8EE2BF", dark: "#3F9578" },
    "green-700": { light: "#7BE4AC", dark: "#1F9767" },
    "red-500": { light: "#F3757A", dark: "#AD3D4F" },
    "red-400": { light: "#FF929E", dark: "#AC485A" },
    "red-100": { light: "#F3757A", dark: "#A87176" },
    "yellow-300": { light: "#FDB16F", dark: "#AB9951" },
    "yellow-500": { light: "#F2C874", dark: "#A47C29" },
    "blue-300": { light: "#98A6FE", dark: "#535CB0" },
    "blue-400": { light: "#5D81FF", dark: "#2133AE" },
    "blue-100": { light: "#BAD0F8", dark: "#7085AC" },
  },
  typography: {

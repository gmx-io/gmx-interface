...
export const DYNAMIC_NETWORK_METADATA: DynamicWalletNetworkMetadata[] = [
  ...
  {
    blockExplorerUrls: [getExplorerUrl(MORPH_HOLESKY)],
    ...
    networkId: MORPH_HOLESKY,
    rpcUrls: RPC_PROVIDERS[MORPH_HOLESKY],
    vanityName: "Morph Holesky",
    privateCustomerRpcUrls: RPC_PROVIDERS[MORPH_HOLESKY],
  },
  {
  ...
  },
  {
    ...
    networkId: OPBNB_TESTNET,
    rpcUrls: RPC_PROVIDERS[OPBNB_TESTNET],
    vanityName: "OP BNB testnet",
    privateCustomerRpcUrls: RPC_PROVIDERS[OPBNB_TESTNET],
  },
];
...
export const NETWORK_METADATA: { [chainId: number]: NetworkMetadata } = {
  ...
  [MORPH_MAINNET]: {
    chainId: "0x" + MORPH_MAINNET.toString(16),
    chainName: "MorphL2",
    nativeCurrency: {
      name: "ETH",
      symbol: "ETH",

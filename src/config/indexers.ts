...
const INDEXER_URLS: Partial<Record<ContractsChainId, IndexerUrlMap>> = {
  [ARBITRUM]: {
    ...
    subsquid: "https://gmx-test.squids.live/gmx-synthetics-arbitrum@6230c4/api/graphql",
  },
  ...
  [AVALANCHE]: {
    ...
    subsquid: "https://gmx-test.squids.live/gmx-synthetics-avalanche@6230c4/api/graphql",
  },
  ...
  [ARBITRUM_SEPOLIA]: {
    subsquid: "https://gmx-test.squids.live/gmx-synthetics-arb-sepolia@6230c4/api/graphql",
  },

  [BOTANIX]: {
    subsquid: "https://gmx-test.squids.live/gmx-synthetics-botanix@6230c4/api/graphql",
    syntheticsStats:
  ...
  [MEGAETH]: {
    subsquid: "https://gmx-test.squids.live/gmx-synthetics-megaeth@6230c4/api/graphql",
    syntheticsStats:

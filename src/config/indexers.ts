...
const INDEXER_URLS: Partial<Record<ContractsChainId, IndexerUrlMap>> = {
  [ARBITRUM]: {
    ...
    subsquid: "https://gmx-test.squids.live/gmx-synthetics-arbitrum@v22car/api/graphql",
  },
  ...
  [AVALANCHE]: {
    ...
    subsquid: "https://gmx-test.squids.live/gmx-synthetics-avalanche@v22cav/api/graphql",
  },

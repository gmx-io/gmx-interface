...
const INDEXER_URLS = {
  ...
  [AVALANCHE_FUJI]: {
    ...
    subsquid: "https://gmx.squids.live/gmx-synthetics-fuji@045a75/api/graphql",
  },

  [ARBITRUM_SEPOLIA]: {
    subsquid: "https://gmx.squids.live/gmx-synthetics-arb-sepolia@045a75/api/graphql",
  },
  ...
  [MEGAETH]: {
    ...
    syntheticsStats:
      "https://app.goldsky.com/project_cmgptuc4qhclc01rh9s4q554a/dashboard/subgraphs/synthetics-megaeth-stats/master-260120151613-540f334/gn",
  },

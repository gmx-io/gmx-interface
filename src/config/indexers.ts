...
const INDEXER_URLS: Partial<Record<ContractsChainId, IndexerUrlMap>> = {
  [ARBITRUM]: {
    ...
    subsquid: "https://gmx.squids.live/gmx-synthetics-arbitrum@decb4e/api/graphql",
  },
  ...
  [AVALANCHE]: {
    ...
    subsquid: "https://gmx.squids.live/gmx-synthetics-avalanche@decb4e/api/graphql",
  },
  ...
  [ARBITRUM_SEPOLIA]: {
    subsquid: "https://gmx.squids.live/gmx-synthetics-arb-sepolia@decb4e/api/graphql",
  },

  [BOTANIX]: {
    subsquid: "https://gmx.squids.live/gmx-synthetics-botanix@decb4e/api/graphql",
    syntheticsStats:
  ...
  [MEGAETH]: {
    subsquid: "https://gmx.squids.live/gmx-synthetics-megaeth@decb4e/api/graphql",
    syntheticsStats:

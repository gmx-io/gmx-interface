...
export const appEventsData: EventData[] = [
  {
    ...
    bodyText: (
      <>
        ...
        /USD, or <Link to="/pools">provide liquidity</Link> to these pools using <TokenSymbolWithIcon symbol="GLV" />{" "}
        [WBTC-USDC], <TokenSymbolWithIcon symbol="WBTC" />, or <TokenSymbolWithIcon symbol="USDC" />.
      </>
    ),
  },
  {

...
const tierIconGlow = `${tierIconBase} bg-blue-300/10 drop-shadow-[0_0_4px_rgba(120,133,255,0.9)] dark:drop-shadow-[0_0_4px_rgba(120,133,255,0.9)] !border-blue-300/50`;

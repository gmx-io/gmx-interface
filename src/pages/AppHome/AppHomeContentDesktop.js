...
export default function AppHomeContentDesktop() {
  return (
    <>
    <div className="content-title-desktop" style={{
        backdropFilter: 'blur(3px)',
        padding: '2rem',
        borderRadius: '1rem'
    }}>
        <h2 style={{ marginBottom: '0' }}><Trans>Become a Liquidity Provider</Trans></h2>
        <br />
    ...
    <div className="content-title-desktop" style={{
        ...
        <h2 style={{ marginBottom: '0' }}><Trans>Buy TMX Token</Trans></h2>
        ...
        <button className="btn text-white orange-cta content-title-desktop-cta" disabled style={{opacity: 0.5, cursor: 'not-allowed'}}>
            <Trans>Buy TMX</Trans>
            <BsArrowRight className="arrow" style={{ marginLeft: "1rem" }} color={"white"} />
        </button>
    </div>

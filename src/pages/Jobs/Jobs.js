        ...
        <div className="section-title-block">
          ...
          <div className="section-title-content">
            ...
            <div className="Page-description">
              <Trans>Job openings at TMX.</Trans>
            </div>
          </div>
        </div>
...
function NoJob() {
  return (
    <Card title={t`No open positions at TMX currently`}>
      <div className="body-para">
        <p className="subheading">
          <Trans>
            TMX is not actively looking for new hires at the moment. However, if you think you can contribute to the
            project, please email <ExternalLink href="#">#</ExternalLink>.
          </Trans>
        </p>
      </div>
    </Card>

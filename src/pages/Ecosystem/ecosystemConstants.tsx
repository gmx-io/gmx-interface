...
export const gmxPages: EcosystemGmxPage[] = [
  ...
  },
  {
    ...
    link: "https://msg.me/GMX_Announcements",
    linkLabel: "msg.me",
...
export const communityProjects: EcosystemCommunityProject[] = [
  {
    ...
    about: msg`GMX Blueberry NFTs`,
    creatorLabel: "@xm_gbc",
    creatorLink: "https://msg.me/xm_gbc",
    chainIds: [ARBITRUM],
  },
  {
    title: msg`GMX Positions Bot`,
    link: "https://msg.me/GMXPositions",
    linkLabel: "msg.me",
    about: msg`Telegram bot for GMX position updates`,
    creatorLabel: "@zhongfu",
    creatorLink: "https://msg.me/zhongfu",
    chainIds: [ARBITRUM, AVALANCHE],
  },
  {
    ...
    creatorLink: "https://msg.me/puroscohiba",
    chainIds: [ARBITRUM, AVALANCHE],
  },
  {
    title: msg`GMX Trading Stats`,
    link: "https://msg.me/GMXTradingStats",
    linkLabel: "msg.me",

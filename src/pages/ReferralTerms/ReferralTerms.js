      ...
      <div className="default-container Page page-layout">
        <div>
          <div className="Page-title-section center">
            <div className="Page-title">NOVA Referral Program</div>
          ...
          <div className="content">
            <div className="section">
              <p className="body-text">
                Welcome to NOVA.io ("we," "us," or "our"), the informational resource for NOVA Protocol, as defined below.
              </p>
              <p className="body-text">
              NOVA.io provides information and resources about the fundamentals of the decentralized non-custodial
                protocol called the NOVA Protocol (the "NOVA Protocol," "Protocol," or "NOVA DApp"). NOVA.io is not an
                available access point to the NOVA Protocol.
              </p>
              <p className="body-text">
                ...
                Affiliate"), explains the terms and conditions by which you may use the NOVAReferral Program ("Referral
            ...
            <div className="section">
              ...
              <p className="body-text">
                The Referral Program allows you to advertise the NOVA DApp, thereby driving traffic to it, whereby you
                may earn a portion of the fees generated ("Rebates") if a person that is not you ("Trader," "Referred
                User") trades in the NOVA DApp after being referred to it from a hyperlink ("Link") or manually input
                code ("Referral Code"). The Trader will benefit from a fee discount ("Discount") associated with the
                Referrer's tier.
              </p>
              <p className="body-text">
                After being referred to the NOVA DApp from a Link, the Trader's browser will save your Referral Code,
            ...
            <div className="section">
              ...
              <p className="body-text">
                2.1 As an Affiliate,NOVA DApp provides you with the Links and Referral Codes necessary to promote the
                NOVA Protocol. You acknowledge and agree it is your sole responsibility to indicate your correct Referral
                Code. You may promote the NOVA Protocol offers in any manner you choose unless it misleads someone about
                the NOVA Protocol.
              </p>
              <p className="body-text">
                2.2 NOVA.io is not responsible for (i) lost sales or lost opportunity to earn Rebates due to any cause,
              ...
              <p className="body-text">
                2.3 You will be excluded from the Referral Program, following the directives of the NOVA tokenholders:
            ...
            <div className="section">
              ...
              <p className="body-text">
              NOVA.io is under no obligation for Rebates or Discounts to any Referrer or Trader. Rebates and Discounts
                are handled following the directives of the NOVA tokenholders.
              </p>
              <p className="body-text">
            ...
            <div className="section">
              ...
              <p className="body-text">
                Under no circumstances shall NOVA.io be liable for any direct, indirect, incidental, punitive, special,
              ...
              <p className="body-text">
                In no event shall NOVA.io's aggregate liability arising out of or in connection with the Site exceed five
            ...
            <div className="section">
              ...
              <p className="body-text">
                You will defend, indemnify, and hold harmless NOVA.io, its affiliates, members, member, managers,
                ...
                service(s) provided by NOVA.io, or your use of the service(s) provided by NOVA.io, including, without
            ...
            <div className="section">
              ...
              <p className="body-text">
                NOVA will not be liable for any losses suffered by you resulting from any modification to the Referral
              ...
              <p className="body-text">
                NOVA may revise these Terms from time to time. We will notify you by updating the date at the top of
                the Terms and maintaining a current version. The most current version of the Terms will always be at
                https://NOVA/referral-terms. All modifications will be effective when they are posted. By using the
            ...
            <div className="section">
              ...
              <p className="body-text">
                ...
                only agreement between you and NOVA concerning the subject matter of these Terms and supersede all
              ...
              <p className="body-text">
                ...
                unenforceable or invalid as a whole. NOVA will amend or replace such provision with one that is valid
              ...
              <p className="body-text">
                ...
                or in connection with any change of control. NOVA may assign or transfer any or all of our rights or
                obligations under these Terms, in whole or part, without notice or obtaining your consent or approval.
              </p>
              <p className="body-text">
                8.6 NOVA will have no responsibility or liability for any failure or delay in performance of the Site,
            ...
            <div className="section">
              ...
              <p className="body-text">
                If you have any questions about these Terms, the Site, or the Interface, please get in touch with NOVA

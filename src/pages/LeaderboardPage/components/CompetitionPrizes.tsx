...
export function CompetitionPrizes({
  ...
  return (
    <BodyScrollFadeContainer className="flex border-b-[0.5px] border-slate-600">
      {prizes.map((prize) => (
...
function CompetitionPrize({ prize }: { prize: Prize }) {
  return (
    <div className="flex grow items-center justify-between gap-8 border-r-[0.5px] border-slate-600 bg-slate-900 p-20 last:border-r-0">

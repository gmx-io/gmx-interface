        ...
        <Modal isVisible={isVisible} setIsVisible={setIsVisible} label={title} className="non-scrollable">
          <div className="Exchange-swap-section">
            ...
            <div className="Exchange-swap-section-bottom">
              ...
              <div className="PositionEditor-token-symbol">esNOVA</div>
            </div>
          </div>
          <div className="VesterDepositModal-info-rows">
            <div className="Exchange-info-row">
              ...
              <div className="align-right">{formatAmount(balance, 18, 2, true)} esNOVA</div>
            </div>
            <div className="Exchange-info-row">
              <div className="Exchange-info-label">
                    ...
                    return (
                      <div>
                        ...
                        <StatsTooltipRow
                          showDollar={false}
                          label={t`Deposited`}
                          value={`${formatAmount(vestedAmount, 18, 2, true)} esNOVA`}
                        />
                        <StatsTooltipRow
                          showDollar={false}
                          label={t`Max Capacity`}
                          value={`${formatAmount(maxVestableAmount, 18, 2, true)} esNOVA`}
                        />
                      </div>
                    );
                  }}
                        ...
                        {amount && nextReserveAmount.gt(maxReserveAmount) && (
                          <>
                            ...
                            <Trans>
                              ...
                              {stakeTokenLabel} to vest {formatAmount(amount, 18, 2, true)} esNOVA.
                            </Trans>
                          </>
                        )}
                      </>
      ...
      <Modal isVisible={isVisible} setIsVisible={setIsVisible} label={title}>
        <Trans>
          <div>
            ...
            <br />
            <br />
            esNOVA tokens that have been converted to NOVA will remain as NOVA tokens.
            <br />
            <br />
            To claim NOVA tokens without withdrawing, use the "Claim" button under the Total Rewards section.
            <br />
            <br />
          </div>
        </Trans>
...
export default function StakeV2({ setPendingTxns, connectWallet }) {
  ...
  if (totalRewardTokensAndGlp && totalRewardTokensAndGlp.gt(0)) {
    ...
    if (processedData.gmxInStakedGmx && processedData.gmxInStakedGmx.gt(0)) {
      gmxAmountStr = formatAmount(processedData.gmxInStakedGmx, 18, 2, true) + " NOVA";
    }
    let esGmxAmountStr;
    if (processedData.esGmxInStakedGmx && processedData.esGmxInStakedGmx.gt(0)) {
      esGmxAmountStr = formatAmount(processedData.esGmxInStakedGmx, 18, 2, true) + " esNOVA";
    }
    let mpAmountStr;
    ...
    <div className="default-container page-layout">
      ...
      <div className="StakeV2-content">
        <div className="StakeV2-cards">
          <div className="App-card StakeV2-gmx-card">
            <div className="App-card-title">NOVA</div>
            ...
            <div className="App-card-content">
              ...
              <div className="App-card-row">
                ...
                <div>
                  {formatKeyAmount(processedData, "gmxBalance", 18, 2, true)} NOVA ($
              ...
              <div className="App-card-row">
                ...
                <div>
                  {formatKeyAmount(processedData, "gmxInStakedGmx", 18, 2, true)} NOVA ($
              ...
              <div className="App-card-row">
                ...
                <div>
                  <Tooltip
                    handle={`$${formatKeyAmount(processedData, "totalNovaRewardsUsd", USD_DECIMALS, 2, true)}`}
                    position="right-bottom"
                    renderContent={() => {
                      return (
                        <>
                          <StatsTooltipRow
                            ...
                            value={`${formatKeyAmount(
                              processedData,
                              "feeNovaTrackerRewards",
                              18,
                              4
                            )} ($${formatKeyAmount(processedData, "feeNovaTrackerRewardsUsd", USD_DECIMALS, 2, true)})`}
                            showDollar={false}
                          />
                          <StatsTooltipRow
                            label="Escrowed NOVA"
                            value={`${formatKeyAmount(
                              processedData,
                              "stakedNovaTrackerRewards",
                              18,
                              4
                            )} ($${formatKeyAmount(
                              processedData,
                              "stakedNovaTrackerRewardsUsd",
                              USD_DECIMALS,
                              2,
                              true
                            )})`}
              ...
              <div className="App-card-row">
                ...
                {totalGmxSupply && (
                  <div>
                    {formatAmount(totalGmxSupply, 18, 0, true)} NOVA ($
          ...
          <div className="App-card">
            ...
            <div className="App-card-content">
              ...
              <div className="App-card-row">
                ...
                <div>
                  {formatKeyAmount(processedData, "esNovaBalance", 18, 2, true)} esNOVA ($
                  {formatKeyAmount(processedData, "esNovaBalanceUsd", USD_DECIMALS, 2, true)})
                </div>
              </div>
              <div className="App-card-row">
                <div className="label">
                ...
                <div>
                  {formatKeyAmount(processedData, "esNovaInStakedNova", 18, 2, true)} esNOVA ($
                  {formatKeyAmount(processedData, "esNovaInStakedNovaUsd", USD_DECIMALS, 2, true)})
                </div>
              </div>
              <div className="App-card-divider"></div>
              <div className="App-card-row">
                ...
                <div>
                  <Tooltip
                    handle={`${formatKeyAmount(processedData, "novaAprTotalWithBoost", 2, 2, true)}%`}
                    position="right-bottom"
                    renderContent={() => (
                      <GMXAprTooltip processedData={processedData} nativeTokenSymbol={nativeTokenSymbol} />
                    )}
              ...
              <div className="App-card-row">
                ...
                <div>
                  {formatKeyAmount(processedData, "stakedEsNovaSupply", 18, 0, true)} esNOVA ($
                  {formatKeyAmount(processedData, "stakedEsNovaSupplyUsd", USD_DECIMALS, 0, true)})
                </div>
              </div>
              <div className="App-card-row">
                <div className="label">
                ...
                <div>
                  {formatAmount(esGmxSupply, 18, 0, true)} esNova (${formatAmount(esGmxSupplyUsd, USD_DECIMALS, 0, true)}
                  )
                </div>
              </div>
              <div className="App-card-divider"></div>
      ...
      <div>
        <div className="Tab-title-section">
          ...
          <div className="Page-description">
            <Trans>
              Convert esNOVA tokens to NOVA tokens.
              <br />
              Please read the{" "}
            ...
            <div className="App-card StakeV2-gmx-card">
              ...
              <div className="App-card-content">
                        ...
                        return (
                          <div>
                            <Trans>
                              ...
                              {formatKeyAmount(vestingData, "gmxVesterVestedAmount", 18, 4, true)} esNOVA deposited for
                              vesting.
                            </Trans>
                          </div>
                        );
                ...
                <div className="App-card-row">
                  ...
                  <div>
                    <Tooltip
                      handle={`${formatKeyAmount(vestingData, "novaVesterClaimable", 18, 4, true)} NOVA`}
                      position="right-bottom"
                      renderContent={() => (
                        <Trans>
                          {formatKeyAmount(vestingData, "novaVesterClaimable", 18, 4, true)} NOVA tokens can be claimed,

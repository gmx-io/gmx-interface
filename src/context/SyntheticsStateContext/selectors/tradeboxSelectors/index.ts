...
export const getTradeBoxLeverageStrategy = (s: { tradeBoxState: TradeboxState }) => {
  const isLeverageEnabled = s.tradeBoxState.isLeverageEnabled;
  const focusedInput = s.tradeBoxState.focusedInput;

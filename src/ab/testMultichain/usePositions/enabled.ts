...
import type { ReaderPositionUtils, SyntheticsReader } from "typechain-types-arbitrum-sepolia/SyntheticsReader";
...
export function usePositions(
  ...
  const {
    ...
    parseResponse: (res) => {
      const positions = res.data.reader.positions.returnValues as ReaderPositionUtils.PositionInfoStructOutput[];

...
import type { ReaderPositionUtils, SyntheticsReader } from "typechain-types/SyntheticsReader";
import type {
  ReaderPositionUtils as ReaderPositionUtilsArbitrumSepolia,
  SyntheticsReader as SyntheticsReaderArbitrumSepolia,
} from "typechain-types-arbitrum-sepolia/SyntheticsReader";
...
export function usePositions(
  ...
  const {
    ...
    chainId === ARBITRUM_SEPOLIA ? `usePositionsData-multichain-${chainId}` : "usePositionsData",
    {
            ...
            calls: {
              positions: {
                ...
                params: [
                  ...
                  0,
                  1000,
                ] satisfies Parameters<SyntheticsReaderArbitrumSepolia["getAccountPositionInfoList"]> &
                  Parameters<SyntheticsReader["getAccountPositionInfoList"]>,
              },
            },
          },
        };
      ...
      parseResponse: (res) => {
        const positions = res.data.reader.positions.returnValues as
          | ReaderPositionUtilsArbitrumSepolia.PositionInfoStructOutput[]
        ...
        return positions.reduce((positionsMap: PositionsData, positionInfo) => {
          ...
          // const data = chainId === ARBITRUM_SEPOLIA ? "" : (position as ReaderPositionUtils.PositionInfoStruct).data;

import { ARBITRUM, AVALANCHE, SEPOLIA_TESTNET, OPTIMISM_MAINNET, MORPH_MAINNET, BASE_MAINNET } from "config/chains";
...
export const availableNetworksForChart = [ARBITRUM, AVALANCHE, SEPOLIA_TESTNET, OPTIMISM_MAINNET, MORPH_MAINNET, BASE_MAINNET];

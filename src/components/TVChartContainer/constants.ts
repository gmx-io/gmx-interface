import { ARBITRUM, AVALANCHE, SEPOLIA_TESTNET, OPTIMISM_GOERLI_TESTNET } from "config/chains";
...
export const availableNetworksForChart = [ARBITRUM, AVALANCHE, OPTIMISM_GOERLI_TESTNET, SEPOLIA_TESTNET];

            ...
            <Tooltip
              ...
              renderContent={() => (
                <div>
                  ...
                  <br />
                  <Trans>
                    Reserve considers the PnL of Open Positions, while Open Interest does not. The Available Liquidity
                    will be the lesser of the difference between the maximum value and the current value for the Reserve
                    and Open Interest.
                  </Trans>
                </div>
              )}

...
export function NetFeeTooltip({ marketStats }: { marketStats: MarketStat[] }) {
  ...
  return (
    <table className="w-full">
      <thead>
        <tr>
          <th className="pb-10 font-normal uppercase text-slate-500">
            <Trans>Pool</Trans>
          </th>
          <th className="pb-10 pr-10 text-right font-normal uppercase text-slate-500">
            <Trans>Longs Net Rate / 1h</Trans>
          </th>
          <th className="pb-10  text-right font-normal uppercase text-slate-500">
            <Trans>Shorts Net Rate / 1h</Trans>
          </th>
        </tr>
      </thead>

      ...
      <ExchangeInfoRow
        label={
          <TooltipWithPortal
            ...
            content={
              <Trans>
                The aximum network fee paid to the network. This fee is a blockchain cost not specific to GMX, and it does
    ...
    <SyntheticsInfoRow
      label={
        <TooltipWithPortal
          ...
          content={
            <Trans>
              The maximum network fee paid to the network. This fee is a blockchain cost not specific to GMX, and it does
              not impact your collateral.
            </Trans>
          }
        >

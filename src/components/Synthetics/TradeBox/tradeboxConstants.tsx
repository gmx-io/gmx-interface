...
export const tradeTypeClassNames = {
  [TradeType.Long]: { active: "!bg-[#1F3445] !text-green-500 border-b border-b-green-500" },
  [TradeType.Short]: { active: "!bg-[#392A46] !text-red-500 border-b border-b-red-500" },
  [TradeType.Swap]: { active: "!bg-[#252B57] !text-blue-300 border-b border-b-blue-300" },
};

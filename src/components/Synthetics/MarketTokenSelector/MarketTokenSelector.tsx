...
function MarketTokenSelectorInternal(props: Props) {
  ...
  const thClassName = cx(
    "text-body-medium sticky top-0 z-10 border-b-[0.5px] border-slate-600 bg-slate-800 text-left font-normal uppercase text-slate-100 last-of-type:text-right",
...
function MarketTokenListItem({
  ...
  return (
    <tr key={market.address} className="group/row cursor-pointer hover:bg-slate-800">
      <td
        className={cx("pr-4 text-slate-100", rowVerticalPadding, isMobile ? "pl-8" : "pl-16")}

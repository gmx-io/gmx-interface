...
export const EARN_OPERATION_STAKE_ES_GMX = "stake-es-gmx";
export const EARN_PORTFOLIO_STAKE_GMX_LINK = `/earn/portfolio?${EARN_OPERATION_QUERY_PARAM}=${EARN_OPERATION_STAKE_GMX}`;
export const EARN_PORTFOLIO_STAKE_ES_GMX_LINK = `/earn/portfolio?${EARN_OPERATION_QUERY_PARAM}=${EARN_OPERATION_STAKE_ES_GMX}`;

...
export const BALANCER_PROGRAM_ANNOUNCEMENT_CAMPAIGN: TargetedAnnouncementCampaign = {
  flag: "showBalancerProgramAnnouncement",
  endTimestamp: Date.UTC(2027, 0, 1),
  dismissedKey: BALANCER_PROGRAM_ANNOUNCEMENT_DISMISSED_KEY,

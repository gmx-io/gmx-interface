    ...
    <div className="Home-token-card-options">
        ...
        <div className="mt-50 flex flex-col gap-15 text-typography-secondary">
          ...
          <div className={cx("flex justify-between", { "flex-col gap-15": isMobile })}>
            <div className={cx("buy flex gap-15", { "flex-col": isMobile })}>
              <BuyLink chainId={chainId} active={active} to={getTrackingLink("/buy_gmx")} network={ARBITRUM}>
                <Trans>Arbitrum</Trans>
              </BuyLink>
              <BuyLink chainId={chainId} active={active} to={getTrackingLink("/buy_gmx")} network={AVALANCHE}>
      ...
      <div className="Home-token-card-option">
        ...
        <div className="mt-50 flex flex-col gap-15 text-typography-secondary">
          ...
          <div className={cx("flex justify-between", { "flex-col gap-15": isMobile })}>
            <div className={cx("buy flex gap-15", { "flex-col": isMobile })}>
              <BuyLink to={getTrackingLink("/pools")} network={ARBITRUM} chainId={chainId} active={active}>
                <Trans>Arbitrum</Trans>
              </BuyLink>

              <BuyLink to={getTrackingLink("/pools")} network={AVALANCHE} chainId={chainId} active={active}>
                <Trans>Avalanche</Trans>
              </BuyLink>

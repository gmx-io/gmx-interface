...
export interface SubaccountGelatoRelayRouterInterface extends Interface {
  ...
  encodeFunctionData(
    ...
    values: [IRelayUtils.RelayParamsStruct, SubaccountApprovalStruct, AddressLike, AddressLike, BytesLike]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    ...
    values: [IRelayUtils.RelayParamsStruct, AddressLike, AddressLike]
  ): string;
...
export interface SubaccountGelatoRelayRouter extends BaseContract {
  ...
  removeSubaccount: TypedContractMethod<
    [relayParams: IRelayUtils.RelayParamsStruct, account: AddressLike, subaccount: AddressLike],
    [void],
    "nonpayable"
  >;

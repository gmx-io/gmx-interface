...
export interface MultichainReceiverInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "allowInitializePath"
      | "dataStore"
  ...
  getEvent(nameOrSignatureOrTopic: "OwnershipTransferred" | "PeerSet"): EventFragment;
...
export interface MultichainReceiver extends BaseContract {
  connect(runner?: ContractRunner | null): MultichainReceiver;

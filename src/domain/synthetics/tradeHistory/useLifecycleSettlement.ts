...
/** A window with more settles than this is treated as unreconcilable rather than silently sampled. */
...
/** `id` is `${transactionHash}:${logIndex}`; log indexes sort numerically, unlike their string form. */

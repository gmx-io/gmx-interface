      ...
      for (const marketAddress of marketsAddresses!) {
        ...
        const hashedKeys = await hashDataMapAsync({
          ...
          maxLongPoolAmountForDeposit: [
            ["bytes32", "address", "address"],
            [MAX_POOL_AMOUNT_FOR_DEPOSIT_KEY, marketAddress, market.longTokenAddress],
          ],
          maxShortPoolAmountForDeposit: [
            ["bytes32", "address", "address"],
            [MAX_POOL_AMOUNT_FOR_DEPOSIT_KEY, marketAddress, market.shortTokenAddress],
          ],
        ...
        request[`${marketAddress}-dataStore`] = {
          ...
          calls: {
            ...
            maxLongPoolAmountForDeposit: {
              methodName: "getUint",
              params: [hashedKeys.maxLongPoolAmountForDeposit],
            },
            maxShortPoolAmountForDeposit: {
              methodName: "getUint",
              params: [hashedKeys.maxShortPoolAmountForDeposit],
            },
            longPoolAmountAdjustment: {
              methodName: "getUint",

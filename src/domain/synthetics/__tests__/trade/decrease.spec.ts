...
const marketInfo: MarketInfo = {
  ...
  withdrawalFeeFactorBalanceWasImproved: BigInt("0x00"),
  withdrawalFeeFactorBalanceWasNotImproved: BigInt("0x00"),
...
const position: PositionInfoLoaded = {
  ...
  netValueAfterAllFees: BigInt("0x00"),
  pnlAfterAllFees: BigInt("0x00"),
  pnlAfterAllFeesPercentage: BigInt("0x00"),

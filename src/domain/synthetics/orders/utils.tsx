...
import { isDecreaseOrderType, isIncreaseOrderType, isOrderForPosition, isSwapOrderType } from "sdk/utils/orders";
...
import { OrderError, OrderInfo, OrderType, PositionOrderInfo, SwapOrderInfo } from "./types";

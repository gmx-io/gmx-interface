...
const batch: PendingTpSlOrderBatch = { id: "batch", chainId: 42161, orders: [tp, sl], existingOrderKeys: ["old"] };
...
function order(key: string, pending = tp): OrderInfo {
  return getOrderCreatedDataFromPendingOrder(pending, key) as unknown as OrderInfo;
}

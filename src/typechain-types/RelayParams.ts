...
export interface RelayParamsInterface extends Interface {}

export interface RelayParams extends BaseContract {
  connect(runner?: ContractRunner | null): RelayParams;
  waitForDeployment(): Promise<this>;

  interface: RelayParamsInterface;

...
export interface MultichainTransferRouter extends BaseContract {
  ...
  /**
   * payable function so that it can be called as a multicall this would be used to move user's funds from their Arbitrum account into their multichain balance
   */

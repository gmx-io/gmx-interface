...
export interface UniswapV2 extends BaseContract {
  ...
  burn: TypedContractMethod<[to: AddressLike], [[bigint, bigint] & { amount0: bigint; amount1: bigint }], "nonpayable">;
  ...
  initialize: TypedContractMethod<[_token0: AddressLike, _token1: AddressLike], [void], "nonpayable">;
  ...
  ): TypedContractMethod<[to: AddressLike], [[bigint, bigint] & { amount0: bigint; amount1: bigint }], "nonpayable">;
  ...
  ): TypedContractMethod<[_token0: AddressLike, _token1: AddressLike], [void], "nonpayable">;

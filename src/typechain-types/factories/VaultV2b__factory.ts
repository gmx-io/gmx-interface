...
export class VaultV2b__factory {
  ...
  static createInterface(): VaultV2bInterface {
    return new Interface(_abi) as VaultV2bInterface;
  }
  static connect(address: string, runner?: ContractRunner | null): VaultV2b {
    return new Contract(address, _abi, runner) as unknown as VaultV2b;
  }
}

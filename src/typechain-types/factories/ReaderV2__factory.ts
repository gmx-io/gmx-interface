...
export class ReaderV2__factory {
  ...
  static createInterface(): ReaderV2Interface {
    return new Interface(_abi) as ReaderV2Interface;
  }
  static connect(address: string, runner?: ContractRunner | null): ReaderV2 {
    return new Contract(address, _abi, runner) as unknown as ReaderV2;
  }
}

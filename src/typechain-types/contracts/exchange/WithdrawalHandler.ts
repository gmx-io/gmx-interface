...
export interface WithdrawalHandlerInterface extends utils.Interface {
  functions: {
    "_executeWithdrawal(bytes32,(uint256,address[],uint256[],uint256[],uint256[],uint256[],uint256[],uint256[],uint256[],bytes[],address[]),address,uint256)": FunctionFragment;
    ...
    "executeWithdrawal(bytes32,(uint256,address[],uint256[],uint256[],uint256[],uint256[],uint256[],uint256[],uint256[],bytes[],address[]))": FunctionFragment;
  ...
  encodeFunctionData(
    ...
    values: [PromiseOrValue<string>, WithdrawalUtils.CreateWithdrawalParamsStruct]
  ): string;

...
export interface RewardTrackerInterface extends Interface {
  ...
  getEvent(nameOrSignatureOrTopic: "Approval" | "Claim" | "Transfer"): EventFragment;
  ...
  encodeFunctionData(functionFragment: "averageStakedAmounts", values: [AddressLike]): string;
  ...
  encodeFunctionData(functionFragment: "claimableReward", values: [AddressLike]): string;
  encodeFunctionData(functionFragment: "cumulativeRewardPerToken", values?: undefined): string;
  encodeFunctionData(functionFragment: "cumulativeRewards", values: [AddressLike]): string;
  encodeFunctionData(functionFragment: "decimals", values?: undefined): string;
  encodeFunctionData(functionFragment: "depositBalances", values: [AddressLike, AddressLike]): string;
  ...
  encodeFunctionData(functionFragment: "isDepositToken", values: [AddressLike]): string;
  encodeFunctionData(functionFragment: "isHandler", values: [AddressLike]): string;
  encodeFunctionData(functionFragment: "isInitialized", values?: undefined): string;
  encodeFunctionData(functionFragment: "name", values?: undefined): string;
  encodeFunctionData(functionFragment: "previousCumulatedRewardPerToken", values: [AddressLike]): string;
  encodeFunctionData(functionFragment: "rewardToken", values?: undefined): string;
  encodeFunctionData(functionFragment: "setDepositToken", values: [AddressLike, boolean]): string;
  ...
  encodeFunctionData(functionFragment: "stakedAmounts", values: [AddressLike]): string;
  encodeFunctionData(functionFragment: "symbol", values?: undefined): string;
  encodeFunctionData(functionFragment: "tokensPerInterval", values?: undefined): string;
  encodeFunctionData(functionFragment: "totalDepositSupply", values: [AddressLike]): string;
...
export interface RewardTracker extends BaseContract {
  ...
  averageStakedAmounts: TypedContractMethod<[arg0: AddressLike], [bigint], "view">;
  ...
  depositBalances: TypedContractMethod<[arg0: AddressLike, arg1: AddressLike], [bigint], "view">;
  ...
  initialize: TypedContractMethod<[_depositTokens: AddressLike[], _distributor: AddressLike], [void], "nonpayable">;
  ...
  previousCumulatedRewardPerToken: TypedContractMethod<[arg0: AddressLike], [bigint], "view">;

  rewardToken: TypedContractMethod<[], [string], "view">;

  setDepositToken: TypedContractMethod<[_depositToken: AddressLike, _isDepositToken: boolean], [void], "nonpayable">;
  ...
  setInPrivateClaimingMode: TypedContractMethod<[_inPrivateClaimingMode: boolean], [void], "nonpayable">;

  setInPrivateStakingMode: TypedContractMethod<[_inPrivateStakingMode: boolean], [void], "nonpayable">;

  setInPrivateTransferMode: TypedContractMethod<[_inPrivateTransferMode: boolean], [void], "nonpayable">;

  stake: TypedContractMethod<[_depositToken: AddressLike, _amount: BigNumberish], [void], "nonpayable">;

  stakeForAccount: TypedContractMethod<
    [_fundingAccount: AddressLike, _account: AddressLike, _depositToken: AddressLike, _amount: BigNumberish],
    [void],
    "nonpayable"
  >;
  ...
  totalDepositSupply: TypedContractMethod<[arg0: AddressLike], [bigint], "view">;
  ...
  unstake: TypedContractMethod<[_depositToken: AddressLike, _amount: BigNumberish], [void], "nonpayable">;
  ...
  getFunction(nameOrSignature: "averageStakedAmounts"): TypedContractMethod<[arg0: AddressLike], [bigint], "view">;
  ...
  getFunction(nameOrSignature: "claim"): TypedContractMethod<[_receiver: AddressLike], [bigint], "nonpayable">;
  getFunction(
  ...
  getFunction(nameOrSignature: "claimableReward"): TypedContractMethod<[arg0: AddressLike], [bigint], "view">;
  getFunction(nameOrSignature: "cumulativeRewardPerToken"): TypedContractMethod<[], [bigint], "view">;
  getFunction(nameOrSignature: "cumulativeRewards"): TypedContractMethod<[arg0: AddressLike], [bigint], "view">;
  ...
  getFunction(nameOrSignature: "inPrivateClaimingMode"): TypedContractMethod<[], [boolean], "view">;
  getFunction(nameOrSignature: "inPrivateStakingMode"): TypedContractMethod<[], [boolean], "view">;
  getFunction(nameOrSignature: "inPrivateTransferMode"): TypedContractMethod<[], [boolean], "view">;
  getFunction(
    nameOrSignature: "initialize"
  ): TypedContractMethod<[_depositTokens: AddressLike[], _distributor: AddressLike], [void], "nonpayable">;
  getFunction(nameOrSignature: "isDepositToken"): TypedContractMethod<[arg0: AddressLike], [boolean], "view">;
  ...
  ): TypedContractMethod<[_depositToken: AddressLike, _isDepositToken: boolean], [void], "nonpayable">;
  ...
  ): TypedContractMethod<[_inPrivateClaimingMode: boolean], [void], "nonpayable">;
  getFunction(
    nameOrSignature: "setInPrivateStakingMode"
  ): TypedContractMethod<[_inPrivateStakingMode: boolean], [void], "nonpayable">;
  getFunction(
    nameOrSignature: "setInPrivateTransferMode"
  ): TypedContractMethod<[_inPrivateTransferMode: boolean], [void], "nonpayable">;
  getFunction(
    nameOrSignature: "stake"
  ): TypedContractMethod<[_depositToken: AddressLike, _amount: BigNumberish], [void], "nonpayable">;
  getFunction(
    ...
    "nonpayable"
  >;
  getFunction(nameOrSignature: "stakedAmounts"): TypedContractMethod<[arg0: AddressLike], [bigint], "view">;
  getFunction(nameOrSignature: "symbol"): TypedContractMethod<[], [string], "view">;
  getFunction(nameOrSignature: "tokensPerInterval"): TypedContractMethod<[], [bigint], "view">;
  getFunction(nameOrSignature: "totalDepositSupply"): TypedContractMethod<[arg0: AddressLike], [bigint], "view">;
  ...
  getFunction(
    ...
    "nonpayable"
  >;
  getFunction(nameOrSignature: "updateRewards"): TypedContractMethod<[], [void], "nonpayable">;
  getFunction(

...
export interface MintableBaseToken extends BaseContract {
  connect(runner?: ContractRunner | null): MintableBaseToken;
  ...
  setMinter: TypedContractMethod<[_minter: AddressLike, _isActive: boolean], [void], "nonpayable">;
  ...
  getFunction(nameOrSignature: "isMinter"): TypedContractMethod<[arg0: AddressLike], [boolean], "view">;
  getFunction(
  ...
  ): TypedContractMethod<[_minter: AddressLike, _isActive: boolean], [void], "nonpayable">;
  getFunction(

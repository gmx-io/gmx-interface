...
export interface GlpManagerInterface extends Interface {
  ...
  getEvent(nameOrSignatureOrTopic: "AddLiquidity" | "RemoveLiquidity"): EventFragment;
  ...
  encodeFunctionData(functionFragment: "getAumInUsdg", values: [boolean]): string;
  ...
  encodeFunctionData(functionFragment: "lastAddedAt", values: [AddressLike]): string;
  encodeFunctionData(
...
export interface GlpManager extends BaseContract {
  ...
  setCooldownDuration: TypedContractMethod<[_cooldownDuration: BigNumberish], [void], "nonpayable">;
  ...
  setInPrivateMode: TypedContractMethod<[_inPrivateMode: boolean], [void], "nonpayable">;
  ...
  getFunction(nameOrSignature: "MAX_COOLDOWN_DURATION"): TypedContractMethod<[], [bigint], "view">;
  ...
  getFunction(
    ...
    "nonpayable"
  >;
  getFunction(nameOrSignature: "aumAddition"): TypedContractMethod<[], [bigint], "view">;
  getFunction(nameOrSignature: "aumDeduction"): TypedContractMethod<[], [bigint], "view">;
  getFunction(nameOrSignature: "cooldownDuration"): TypedContractMethod<[], [bigint], "view">;
  getFunction(nameOrSignature: "getAum"): TypedContractMethod<[maximise: boolean], [bigint], "view">;
  getFunction(nameOrSignature: "getAumInUsdg"): TypedContractMethod<[maximise: boolean], [bigint], "view">;
  getFunction(nameOrSignature: "getAums"): TypedContractMethod<[], [bigint[]], "view">;
  ...
  getFunction(nameOrSignature: "inPrivateMode"): TypedContractMethod<[], [boolean], "view">;
  getFunction(nameOrSignature: "isHandler"): TypedContractMethod<[arg0: AddressLike], [boolean], "view">;
  getFunction(nameOrSignature: "lastAddedAt"): TypedContractMethod<[arg0: AddressLike], [bigint], "view">;
  getFunction(
  ...
  ): TypedContractMethod<[_aumAddition: BigNumberish, _aumDeduction: BigNumberish], [void], "nonpayable">;
  getFunction(

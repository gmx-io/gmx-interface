/*eslint-disable*/ module.exports = {
  messages: {
    ...
    FEES: "手数料",
    Fees: "手数料",
    "Fees may vary depending on which asset you sell GLP for.": "GLPを売却して入手する資産によって手数料は異なります。",
    "Fees may vary depending on which asset you use to buy GLP.":
      "GLPをどの資産で購入するかによって手数料は異なります。",
    ...
    "GMX tokens can be claimed, use the options under the Total Rewards section to claim them.":
      "GMXトークンを請求することができます。請求するには全報酬セクションの下部にある選択肢を利用してください。",
    ...
    "Please mint GLP using another token": "別のトークンを使用してGLPをミントしてください",

 ...
 * IDL can be found at `src/idl/gmsol_stake.json`.
 */
export type GmsolStake = {
    ...
    },
    {
      ...
      "type": {
        ...
        "fields": [
          ...
          {
            "name": "market_closed_min_collateral_factor_for_liquidation",
            "type": "u128"
          },
          {
            "name": "market_closed_borrowing_fee_base_factor",
            "type": "u128"
          },
          {
            "name": "market_closed_borrowing_fee_above_optimal_usage_factor",
            "type": "u128"
          },
          {
            "name": "reserved",
  ...
  "constants": [
    ...
    {
      "name": "GLOBAL_STATE_RESERVED_LEN",
      "type": "u32",
      "value": "256"
    },
    {
    ...
    {
      "name": "LP_TOKEN_CONTROLLER_RESERVED_LEN",
      "type": "u32",
      "value": "256"
    },
    {

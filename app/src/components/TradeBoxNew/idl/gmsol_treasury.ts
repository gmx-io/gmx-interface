...
export type GmsolTreasury = {
  ...
  instructions: [
    {
      ...
      accounts: [
        ...
        {
          name: 'receiver';
          docs: ['Swap order owner (the receiver).'];
          writable: true;
          pda: {
            seeds: [
              {
        ...
        {
          name: 'user';
          docs: ['The user account for `owner`.'];
          writable: true;
        },
        {
          name: 'swapInToken';
        ...
        },
        {
          ...
          docs: ['Swap in token receiver vault.'];
          writable: true;
        },
        {
          name: 'swapOutTokenReceiverVault';
          docs: ['Swap out token receiver vault.'];
          writable: true;
        },
        {
          name: 'swapInTokenEscrow';
          docs: ['The escrow account for swap in token.'];
          writable: true;
        },
        {
          name: 'swapOutTokenEscrow';
          docs: ['The escrow account for swap out token.'];
          writable: true;
        },
        {
          name: 'order';
          docs: ['The order account.'];
          writable: true;
        },
        {
          name: 'eventAuthority';
    ...
    },
    {
      ...
      accounts: [
        ...
        {
          name: 'config';
          docs: ['Config to initialize with.'];
        },
        {
          name: 'receiver';
          docs: ['Receiver.'];
        ...
        {
          name: 'market';
          docs: ['Market to claim fees from.'];
          writable: true;
        },
        {
          name: 'token';
    ...
    },
    {
      ...
      docs: ['Complete GT Exchange.'];
      discriminator: [15, 159, 24, 137, 211, 116, 174, 60];
      accounts: [
        {
          name: 'owner';
          docs: ['Owner.'];
    ...
    },
    {
      ...
      docs: ['Confirm GT buyback.'];
      discriminator: [215, 130, 25, 182, 202, 240, 77, 149];
      accounts: [
        {
          name: 'authority';
          docs: ['Authority.'];
        ...
        },
        {
          ...
          docs: ['Store.'];
          writable: true;
          relations: ['config', 'gtExchangeVault'];
        },
        {
          name: 'config';
          docs: ['Config.'];
    ...
    },
    {
      name: 'createSwap';
      docs: ['Create a swap.'];
      discriminator: [176, 207, 238, 60, 195, 2, 203, 91];
      accounts: [
        {
          name: 'authority';
          docs: ['Authority.'];
        ...
        {
          name: 'user';
          docs: ['The user account for `receiver`.'];
          writable: true;
        },
        {
          name: 'swapInTokenEscrow';
    ...
    },
    {
      name: 'createSwapV2';
      docs: ['Create a swap.'];
      discriminator: [83, 172, 205, 183, 106, 214, 68, 144];
      accounts: [
        {
          name: 'authority';
          docs: ['Authority.'];
        ...
        },
        {
          ...
          docs: ['Callback config account.'];
          optional: true;
        },
        {
          name: 'callbackPartitionedDataAccount';
          docs: ['Callback action stats account.'];
          optional: true;
        },
      ];
      args: [
    ...
    },
    {
      ...
      docs: ['Deposit to treasury vault.'];
      discriminator: [60, 157, 62, 63, 219, 46, 207, 84];
      accounts: [
        {
          name: 'authority';
          docs: ['Authority.'];
        ...
        },
        {
          ...
          pda: {
            seeds: [
              {
                kind: 'const';
                value: [103, 116, 95, 98, 97, 110, 107];
              },
              {
                kind: 'account';
    ...
    },
    {
      ...
      accounts: [
        ...
        {
          name: 'store';
          docs: ['The store that controls this config.'];
          writable: true;
        },
        {
          name: 'config';
    ...
    },
    {
      ...
      discriminator: [34, 70, 200, 37, 152, 237, 255, 216];
      accounts: [
        {
          name: 'authority';
          docs: ['Authority.'];
        ...
        {
          name: 'treasuryVaultConfig';
          docs: ['Treasury vault config account to initialize.'];
          writable: true;
          pda: {
            seeds: [
              {
    ...
    },
    {
      ...
      discriminator: [63, 143, 140, 147, 26, 69, 75, 10];
      accounts: [
        {
          name: 'authority';
          docs: ['Authority.'];
    ...
    {
      name: 'prepareGtBank';
      docs: ['Prepare GT Bank.'];
      discriminator: [201, 61, 232, 124, 134, 42, 82, 158];
      accounts: [
        {
          name: 'authority';
          docs: ['Authority.'];
    ...
    },
    {
      ...
      discriminator: [77, 30, 206, 14, 174, 42, 208, 212];
      accounts: [
        {
          name: 'authority';
          docs: ['Authority.'];
    ...
    },
    {
      ...
      docs: ['Set buyback factor.'];
      discriminator: [199, 203, 251, 181, 132, 180, 103, 130];
      accounts: [
        {
          name: 'authority';
          docs: ['Authority.'];
    ...
    },
    {
      name: 'setGtFactor';
      docs: ['Set GT factor.'];
      discriminator: [82, 130, 30, 189, 79, 73, 29, 109];
      accounts: [
        {
          name: 'authority';
          docs: ['Authority.'];
    ...
    },
    {
      ...
      docs: ['Set referral reward factors.'];
      discriminator: [31, 230, 34, 144, 43, 222, 71, 88];
      accounts: [
        {
          name: 'authority';
          docs: ['Authority.'];
    ...
    },
    {
      ...
      docs: ['Set treasury vault config.'];
      discriminator: [243, 119, 94, 154, 126, 51, 26, 65];
      accounts: [
        {
          name: 'authority';
          docs: ['Authority.'];
    ...
    },
    {
      name: 'syncGtBank';
      docs: ['Sync GT Bank.'];
      discriminator: [198, 231, 68, 22, 252, 46, 223, 2];
      accounts: [
        {
          name: 'authority';
          docs: ['Authority.'];
    ...
    },
    {
      name: 'syncGtBankV2';
      docs: ['Sync GT Bank.'];
      discriminator: [161, 150, 114, 49, 152, 89, 94, 45];
      accounts: [
        {
          name: 'authority';
          docs: ['Authority.'];
    ...
    },
    {
      ...
      discriminator: [75, 32, 1, 58, 29, 123, 20, 11];
      accounts: [
        {
          name: 'authority';
          docs: ['Authority.'];
    ...
    },
    {
      ...
      docs: ['Transfer the receiver permission to a new address.'];
    ...
    },
    {
      ...
      docs: ['Withdraw from treasury vault.'];
      discriminator: [249, 29, 124, 28, 213, 68, 237, 110];
      accounts: [
        {
          name: 'authority';
          docs: ['Authority.'];
  ...
  accounts: [
    ...
    {
      name: 'gtBank';
      discriminator: [22, 238, 251, 171, 93, 246, 199, 113];
    },
    {
      name: 'gtExchange';
    ...
    {
      name: 'treasuryVaultConfig';
      discriminator: [239, 10, 243, 108, 249, 129, 212, 29];
    },
  ];
  types: [
    {
    ...
    {
      name: 'tokenConfig';
      docs: ['Token config for treasury.'];
      serialization: 'bytemuck';
      repr: {
        kind: 'c';
      };
    ...
    {
      name: 'treasuryVaultConfig';
      docs: ['Treasury vault config account.'];
      serialization: 'bytemuck';
      repr: {
        kind: 'c';
      };

    ...
    <div data-qa={qa}>
      <div className="Exchange-swap-section buy-input" onClick={handleBoxClick}>
        <div className="buy-input-top-row">
          <div data-label="left" className="text-slate-100 text-[1.2rem]">
            {topLeftLabel}
          </div>
          <div
            data-label="right"
          ...
          >
            <span className="text-slate-100 text-[1.2rem]">{topRightLabel}</span>
            {topRightValue && (
        ...
        {/* <div className='flex items-center justify-between mt-[0.2rem]'>
          <div className='text-[#A3A3A3] text-[1.2rem]'>{topLeftValue || '$0.00'}</div>
        </div> */}
      </div>

...
/**
 * @deprecated Gelato shuts its relay services down on 2026-09-01. Express submission goes through
 * GMX Relay (`sendToGmxRelay`), which needs no client-held key. Removed in the next major release.
 */

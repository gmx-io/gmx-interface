    ...
    <Modal onClose={onClose}>
      ...
      <ModalBody>
        <div className="flex flex-col gap-12">
          ...
          <p>
            <Trans>
              Alternative links are in the <a href="https://docs.gmx.io/docs/frontends">docs</a>. By clicking Launch
              app you accept the <a href="https://gmx.io/#/terms-and-conditions">T&Cs</a> and{" "}

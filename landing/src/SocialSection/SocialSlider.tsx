...
export function SocialSlider() {
  return (
    <div className="relative">
      <div className="flex flex-row gap-16 overflow-x-auto scrollbar-hide">
        ...
        >
          <>
            ...
            <img src={AndrewAttachment} alt="Andrew Attachment" className="mt-8 w-full object-cover" />
          </>
        </SocialCard>
        <SocialCard
          author="Lucky"
        ...
        >
          <>
            ...
            <img src={LuckyAttachment} alt="Lucky Attachment" className="mt-8 h-[70px] w-full object-cover sm:h-auto" />
          </>
        </SocialCard>
        <SocialCard
          author="Chainlink"
        ...
        >
          <>
            ...
            <img src={ChainLinkAttachment} alt="ChainLink Attachment" className="w-full object-cover" />
          </>
        </SocialCard>
        <SocialCard
          author="GMX"
        ...
        >
          ...
          <img src={GMXAttachment} alt="GMX Attachment" className="w-full object-cover" />
        </SocialCard>
        <SocialCard
          author="LayerZero"
        ...
        >
          <>
            <Trans>
              <p>
                <span className="text-blue-100">@GMX_IO</span> enters into a Data Partnership with Token TerminalGMX is
                a leading permissionless perpetual exchange built on <span className="text-blue-100">@Arbitrum</span>{" "}
                and <span className="text-blue-100">@Avax</span>.
              </p>
            ...
            <img src={TokenTerminalAttachment} alt="Token Terminal Attachment" className="w-full object-cover" />
          </>
        </SocialCard>
        <SocialCard
          author="Tradao"
        ...
        >
          <>
            ...
            <img src={TradaoAttachment} alt="Tradao Attachment" className="w-full object-cover" />
          </>
        </SocialCard>
        <SocialCard
          ...
          <>
            <Trans>
              <p>
                ...
                interest, and utilization of capital. Best place to swap between major assets on Arbitrum and exposure
                to the Arb airdrop
              </p>
            </Trans>
            <img src={MoonboyAttachment} alt="Moonboy Attachment" className="w-full object-cover" />
          </>
        </SocialCard>
      </div>
    </div>

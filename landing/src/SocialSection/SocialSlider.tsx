    ...
    <div className="flex flex-row gap-16 overflow-x-auto scrollbar-hide">
      ...
      >
        <>
          ...
          <img src={LuckyAttachment} alt="Lucky Attachment" className="mt-8 w-full object-cover" />
        </>
      </SocialCard>
      <SocialCard
        author="Chainlink"
      ...
      >
        <>
          ...
          <p>
            Thank you to the hundreds of thousands of GMX users who continue to support permissionless onchain trading.
          </p>
        </>

...
export function SocialCard({ author, avatarUrl, date, postLink, username, children }: Props) {
  ...
  return (
    <div
      onClick={onClick}
      className="bg-fiord-600 duration-180 group relative flex h-[320px] w-[280px] flex-shrink-0 cursor-pointer flex-col gap-16 rounded-16 p-16 transition-transform hover:z-20 hover:-translate-y-4 sm:h-[440px] sm:w-[420px] sm:p-20"
    >

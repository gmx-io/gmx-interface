...
export function SocialCard({ author, avatarUrl, date, postLink, username, children }: Props) {
  ...
  return (
    <div
      onClick={onClick}
      className="bg-fiord-600 duration-180 group relative flex h-[320px] w-[280px] flex-shrink-0 cursor-pointer flex-col gap-16 overflow-hidden rounded-16 p-16 transition-transform hover:z-20 hover:-translate-y-4 sm:h-[440px] sm:w-[420px] sm:p-20"
    >
      <div className="flex flex-row items-start justify-between">
        ...
        <div className="duration-180 rounded-8 bg-[#1E2033] p-12 text-slate-100 transition-colors group-hover:bg-blue-600 group-hover:text-white">
